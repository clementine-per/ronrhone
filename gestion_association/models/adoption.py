...
from gestion_association.models.animal import StatutAnimal, Animal, TypeChoice, SexeChoice, TrancheAge
...
class TarifAdoption(models.Model):
    ...
    tranche_age = models.CharField(max_length=10,
                                   verbose_name="Tranche d'âge",
                                   choices=[(tag.name, tag.value) for tag in TrancheAge])
    vaccin_ok = models.CharField(max_length=3, blank=True,
